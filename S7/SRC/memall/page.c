...
void initialise_paging()
{
    ...
    frames = (u32int*)halloc(INDEX_FROM_BIT(nframes));
    memset(frames, 0, INDEX_FROM_BIT(nframes));
    
    kernel_directory = (page_directory_t*)halloc_a(sizeof(page_directory_t));
...
page_t *get_page(u32int address, int make, page_directory_t *dir)
{
    ...
    {
        u32int tmp;
        dir->tables[table_idx] = (page_table_t*)halloc_ap(sizeof(page_table_t), &tmp);
